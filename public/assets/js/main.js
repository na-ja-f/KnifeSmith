(function ($) {
    ...
    $('button[data-bs-toggle="tab"]').on('shown.bs.tab', function (e) {
     ...
     $('[data-countdown]').each(function() {
        var $this = $(this),
            finalDate = new Date().getTime() + 5 * 60 * 1000; // 5 minutes in milliseconds
    
        $this.countdown(finalDate, function(event) {
            var minutes = event.strftime('%M');
            var seconds = event.strftime('%S');
    
            // If the countdown reaches zero, you can hide or update your HTML elements accordingly
            if (minutes === "00" && seconds === "00") {
                $(this).html("Countdown has reached zero!");
            } else {
